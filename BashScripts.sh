...
az login
az account set --subscription "MPN - Suresh Inuguru"
...
az keyvault create --name "sinuguru" --resource-group "sinuguru-infra" --location uksouth
az keyvault secret set --vault-name "sinuguru" --name "tstateaccess" --value {$ACCOUNT_KEY}
az keyvault secret show --vault-name "sinuguru" --name "tstateaccess"
